...
export default function Landing() {
  ...
  return (
    <div className="relative font-sans bg-[#f0f8ff] text-gray-800 overflow-x-hidden">
      ...
      <div className="relative z-10 w-[80vw] mx-auto px-4">
        ...
        <nav className="relative z-50 bg-white/80 backdrop-blur-md shadow-sm top-0">
          <div className="w-full mx-auto px-6 py-6 flex items-center justify-between">
            <div className="flex items-center gap-3 text-5xl font-bold text-[#00bcd4]">
              <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="#00bcd4" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2z" />
                <path d="M12 8v8M8 12h8" />
              </svg>
              Medilink
            </div>
            <ul className="hidden md:flex gap-10 text-xl text-gray-600 font-medium">
              {NAV_LINKS.map(l => (
                <li key={l} className="hover:text-[#00bcd4] cursor-pointer transition-colors">{l}</li>
              ))}
            </ul>
            <button className="hidden md:block bg-[#00bcd4] text-black text-xl px-8 py-3 rounded-full font-semibold hover:bg-[#0097a7] transition-colors shadow">
          ...
          {menuOpen && (
            <div className="md:hidden bg-white border-t px-6 py-5 flex flex-col gap-4">
              {NAV_LINKS.map(l => <a key={l} className="text-lg text-gray-600 hover:text-[#00bcd4]" href="#">{l}</a>)}
              <Link to="/signup" style={{ textDecoration: 'none' }}>
                <button className="bg-[#60a7b1] text-gray-700 text-lg px-6 py-2.5 rounded-full font-semibold w-fit">Appointment</button>
              </Link>
            </div>
          )}
        </nav>
        ...
        {/* HERO */}
        <section className="relative z-10 w-full mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            <p className="text-[#00bcd4] font-semibold uppercase tracking-widest text-base mb-3">Medical</p>
            <h1 className="text-6xl md:text-7xl font-extrabold text-gray-900 leading-tight mb-5">
              Healthcare_01<br />Solutions
            </h1>
            <p className="text-gray-500 text-xl mb-8 max-w-md">
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-80 h-80 md:w-96 md:h-96 bg-gradient-to-br from-[#00bcd4] to-[#0097a7] rounded-[40%_60%_60%_40%/50%_40%_60%_50%] flex items-center justify-center shadow-2xl overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 bg-white rounded-2xl px-4 py-2 shadow-lg flex items-center gap-2">
                ...
                <span className="text-base font-bold text-gray-700">+500 Doctors</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* QUICK INFO CARDS */}
        <section className="relative z-10 w-full mx-auto px-6 pb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-[#fffbfb] text-gray-700 rounded-2xl p-5 shadow-lg">
              ...
              <p className="text-base opacity-90">Mon–Fri: 8am – 8pm</p>
              <p className="text-base opacity-90">Sat–Sun: 9am – 5pm</p>
              <button className="mt-3 bg-white/20 hover:bg-white/30 text-gray-700 text-sm px-4 py-1.5 rounded-full transition-colors">Info</button>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-base text-gray-700">Appointment</span>
              </div>
              <p className="text-sm text-gray-400 mb-3">Book your visit with our specialists quickly and easily.</p>
              <Link to="/signup" style={{ textDecoration: 'none' }}>
                <button className="bg-[#00bcd4] text-gray text-sm px-4 py-1.5 rounded-full hover:bg-[#0097a7] transition-colors">Request</button>
              </Link>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-base text-gray-700">Find Doctors</span>
              </div>
              <p className="text-sm text-gray-400 mb-3">Search and connect with top certified healthcare professionals.</p>
              <button className="bg-[#00bcd4] text-gray-700 text-sm px-4 py-1.5 rounded-full hover:bg-[#0097a7] transition-colors">Doctors</button>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-lg border border-gray-100">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-[#00bcd4]/10 rounded-lg flex items-center justify-center">
                ...
                <span className="font-bold text-base text-gray-700">Find Locations</span>
              </div>
              <p className="text-sm text-gray-400 mb-3">Locate nearby clinics and hospitals in your area.</p>
              <button className="bg-[#00bcd4] text-gray-700 text-sm px-4 py-1.5 rounded-full hover:bg-[#0097a7] transition-colors">Locations</button>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 bg-white py-20 px-6">
          <div className="w-full mx-auto">
            <div className="text-center mb-12">
              <p className="text-[#00bcd4] font-semibold uppercase tracking-widest text-base mb-2">Service</p>
              <h2 className="text-5xl font-extrabold text-gray-900">Our Medical Services</h2>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="relative w-72 h-72">
                  ...
                  {["Eye Care", "Cardiology", "Medicine", "Dental", "Orthopedic"].map((s, i) => {
                    ...
                    return (
                      <div
                        key={s}
                        className="absolute bg-white shadow-md rounded-full px-3 py-1 text-sm font-semibold text-[#00bcd4] border border-[#00bcd4]/20 whitespace-nowrap"
              ...
              <div className="flex-1">
                <h3 className="text-4xl font-bold text-gray-900 mb-4">Dental Care Service</h3>
        ...
        <section className="relative z-10 py-20 px-6">
          <div className="w-full mx-auto">
            <div className="text-center mb-12">
              <p className="text-[#00bcd4] font-semibold uppercase tracking-widest text-base mb-2">Features</p>
              <h2 className="text-5xl font-extrabold text-gray-900">Our Speciality</h2>
            </div>
            <div className="bg-gradient-to-r from-[#00bcd4] to-[#0097a7] rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8 shadow-2xl">
              <div className="flex-1 text-white">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-3xl font-bold">Online Appointment</h3>
                </div>
        ...
        <section className="relative z-10 bg-white py-20 px-6">
          <div className="w-full mx-auto flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <p className="text-[#00bcd4] font-semibold uppercase tracking-widest text-base mb-3">Time Table</p>
              <h2 className="text-5xl font-extrabold text-gray-900 mb-5">Appointment<br />Schedules</h2>
              ...
              <div className="relative">
                <div className="w-64 h-64 bg-gradient-to-br from-[#00bcd4] to-[#0097a7] rounded-3xl shadow-2xl p-4 transform rotate-3">
                  <div className="bg-white/20 rounded-xl p-2 mb-2">
                    <p className="text-white font-bold text-center text-base">February 2026</p>
                  </div>
                  <div className="grid grid-cols-7 gap-1">
                    {["S", "M", "T", "W", "T", "F", "S"].map((d, i) => (
                      <div key={i} className="text-white/70 text-sm text-center font-semibold">{d}</div>
                    ))}
                    {Array.from({ length: 28 }, (_, i) => (
                      <div key={i} className={`text-sm text-center py-1 rounded-lg font-medium ${i + 1 === 16 ? "bg-white text-[#00bcd4]" : "text-white"
                        }`}>{i + 1}</div>
                    ))}
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-white rounded-2xl shadow-xl flex items-center justify-center border border-gray-100">
                  <div className="text-center">
                    <p className="text-4xl font-extrabold text-[#00bcd4]">24</p>
                    <p className="text-sm text-gray-500 font-semibold">Slots Today</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="relative z-10 py-20 px-6">
          <div className="w-full mx-auto">
            <div className="text-center mb-12">
              <p className="text-[#00bcd4] font-semibold uppercase tracking-widest text-base mb-2">Team</p>
              <h2 className="text-5xl font-extrabold text-gray-900">Our Doctors</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
              {[
                ...
                <div key={doc.name} className="bg-white rounded-3xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow group border border-gray-100">
                  ...
                  <h3 className="font-bold text-gray-900 text-xl">{doc.name}</h3>
                  <p className="text-[#00bcd4] font-semibold text-base mt-1">{doc.role}</p>
